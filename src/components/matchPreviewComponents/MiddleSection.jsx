    ...
    return ( 
        <div className="flex pr-8">
            ...
            <div className="content-center pr-3">
                <Items primaryPlayer={primaryPlayer} size={"size-10"}></Items>
            </div>
